...
class UploadsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create upload" do
    assert_difference('Upload.count') do
      post uploads_url, params: { upload: { bucket: @upload.bucket, mime_type: @upload.mime_type, name: @upload.name, path: @upload.path } }
    end
  ...
  test "should update upload" do
    patch upload_url(@upload), params: { upload: { bucket: @upload.bucket, mime_type: @upload.mime_type, name: @upload.name, path: @upload.path } }
